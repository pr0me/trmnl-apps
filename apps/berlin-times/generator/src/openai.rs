...
fn research_story_schema(categories: &Value) -> Value {
    json!({
        ...
        "properties": {
            ...
            "published_at": {
                "type": "string",
                "description": "Verified publication or material-update timestamp from the selected article, as an RFC 3339 date-time.",
                "format": "date-time"
            },
            "sources": {
                "type": "array",
...
mod tests {
    ...
    -> std::result::Result<(), Box<dyn std::error::Error>> {
        ...
        assert!(prompt.contains("2026-08-04T16:30:00+00:00"));
        assert!(prompt.contains("2026-08-03T04:30:00+00:00"));
